/**
 * Cailin Assistant — Message Handler
 * WhatsApp bot using Baileys ESM
 * Creator Mommy Kyu — https://whatsapp.com/channel/0029Vb7gcbuLdQelWzrTzD3D
 */
  ...
  if (command.limit &&!isOwner) {
    ...
    if (!isPremium) {
      if ((userData?.limit?? 0) <= 0) {
        ...
        return ctx.reply(global.msg?.limit || '❌ *Your limit is exhausted!*');
      }
